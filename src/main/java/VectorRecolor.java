...
public class VectorRecolor {
    ...
    private static final boolean REMOVE_LINES_MODE = false; // Default: false (No box-forming or text searching)
    ...
    public static void main(String[] args) {
        ...
        for (File inputFile : files) {
            ...
            try (PDDocument document = Loader.loadPDF(inputFile)) {
                ...
                // Only run the extraction, analysis, and stripping pipeline if the removal mode flag is active
                if (REMOVE_LINES_MODE) {
                    System.out.println("Line removal mode is TRUE. Executing in-memory layout analysis...");
                    ...
                    for (int i = 0; i < document.getNumberOfPages(); i++) {
                        ...
                        if (!visualBoxes.isEmpty()) {
                            ...
                            // Compile list of target segments to omit from the file stream
                ...
                if (SAVE_DRAWINGS_ONLY) {
                    ...
                    System.out.println(" -> Successfully saved file to: " + outputFile.getAbsolutePath());
                }
            ...
            if (token instanceof Operator) {
                ...
                if (opName.equals("S") || opName.equals("s") || opName.equals("f") || opName.equals("B") || opName.equals("b") || opName.equals("n")) {
                    if (!skipCurrentPathSegment) {
                        ...
                        filteredTokens.add(Operator.getOperator("n")); 
                    }
                    currentPathSubTokens.clear();
